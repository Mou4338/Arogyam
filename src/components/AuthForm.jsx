  ...
  return (
    <div className="bg-white shadow-md rounded-xl px-8 py-6 w-full max-w-md">
      <div className="text-center mb-6">
        <img src="public\logo.png" className="h-10 mx-auto mb-3" alt="Arogyam Logo" />
      ...
      <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); onSubmit(form) }}>
        <div>
          ...
          <input
            ...
            required
            className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-teal-500"
          />
        </div>
        <div>
