    ...
    <>
      ...
      <div className="bg-slate-100 py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
          <div className="flex-1 p-4 bg-[#3f8578] border border-black rounded-2xl shadow-xl max-h-[650px] p-4 space-y-4 scrollbar-color-black overflow-y-auto">
            <Remainder user={user}/>
          </div>
          <div className="w-full lg:w-1/3 p-4 bg-[#3f8578] rounded-lg shadow text-white">
            <AddRemainder user={user}/>
          </div>
        </div>
      </div>
    </>
