...
const page = () => {
  return (
    <>
      ...
      <h1 className="text-4xl font-bold text-[#3f8578] mb-6">Terms of Use</h1>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-black">1. Purpose of Use</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-black">2. No Medical Liability</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-black">3. Data Usage & Privacy</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-black">4. Third-Party Integrations</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-black">5. User Responsibilities</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2 text-black">6. Modifications to Terms</h2>
        <p>
